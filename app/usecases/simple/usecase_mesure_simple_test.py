...
@patch('app.usecases.simple.usecase_mesure_simple.get_model')
...
def test_mesure_simple_nn_model_not_trained(mock_get_model):
    # Model setup without a trained neural network
...
def test_mesure_simple_nn_missing_files(mock_get_model):
    # Model missing encoder, scaler, and indices filenames
...
def test_mesure_simple_nn_missing_normalization_parameters(mock_joblib_load, mock_get_model):
    # Model setup missing target normalization parameters
    mock_get_model.return_value = {
        "nn_model": MagicMock(),
        "encoder_filename": "encoder.pkl",
        "scaler_filename": "scaler.pkl",
